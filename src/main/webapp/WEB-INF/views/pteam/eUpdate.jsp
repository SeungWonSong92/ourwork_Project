            ...
            <br>
               <h4>${ employee.eName }님의 회원 정보 수정</h4>
                <tr>
                    ...
                    <td class="in"><input type="text" textalign="center" name="employee.eName" size="50" class="in" value="${ employee.eName }" readonly="readonly"></td>
                ...
                <tr>
                    ...
                    <td class="in"><input type="text" class="in" name="address" value="${ employee.address }" readonly></td>
                ...
                <tr>
                        ...
                        <td class="in"><input type="date" name="join_date" class="in" value="${ employee.join_date }">원</td>
            ...
            <table class="b12">
                    <tr>
                         <td colspan="2" class="btn1">
                                ...
                                <button type="button" class="btn btn-secondary btn-sm">취소하기</button>
                         </td>
                        </tr>
            </table>
            </form>
