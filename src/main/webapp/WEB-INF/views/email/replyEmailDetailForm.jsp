...
<body>
									...
									<ul id="mailArea">
										<li>
											<div id="addMail" class="mgr">
												<span class="Madd" id="fff">${ eId }@ourwork.com</span>
							...
							<td colspan="2"><div class="custom-file mb-3">
									...
									<c:if test="${ !empty alist }">
							            <c:forEach var="alist" items="${alist}" varStatus="status">
							         		...
							         		<input type="hidden" id="aFile" name="uploadFile2" value="${ alist.changeName }">
							         		</p>
							            </c:forEach>
         							</c:if>
								</div></td>
						...
						<tr>
							...
							<td colspan="2">
								<div id="title" style="border: 1px solid rgb(179, 179, 179)">
									<textarea name="mTitle" wrap="off" id="ra3" autocomplete="false" style="width: 800px; border: none; resize: none; overflow: hidden; display: inline;" rows="1">RE: ${ email.mTitle }</textarea>
								</div>
							</td>
						</tr>
						<tr><td>&nbsp;</td></tr>
						<tr>
							<td colspan="3"><textarea class="rc2 content" name="mContent" id="mContent">
								<br><br>
								-----Original Message-----<br>
								<span style="font-size: 10pt;">﻿<b>From:</b></span> ${ email.eeId }@ourwork.com<br>
								<span style="font-size: 10pt;">﻿<b>To:</b></span> ${ email.reId }@ourwork.com<br>
								<span style="font-size: 10pt;">﻿<b>send:</b></span> ${ email.sendDate }<br>
								<span style="font-size: 10pt;">﻿<b>Subject:</b></span> ${ email.mTitle }<br><br><br>
								${ email.mContent }
							</textarea></td>
						</tr>
					</table>
	...
	<script>
        ...
        $("#letssave").click(function(){
           	oEditors.getById["mContent"].exec("UPDATE_CONTENTS_FIELD", []);
       		var formObj = $("form[name='form']");
        	formObj.attr("action", "delTemp.do");
        	formObj.submit();
        });
    </script>
</body>
