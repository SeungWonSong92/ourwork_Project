...
<body>
		...
		<div class="section2">
			<form method="post" name="form" enctype="multipart/form-data">
				<div id="btn-wrapper" align="left">
					...
					<button type="submit" class="btn btn-secondary btn-sm" id="againtemp">임시저장</button>
				</div>
				...
				<div id="table-wrapper">
					<table>
						...
						<tr><td>&nbsp;</td></tr>
						<tr>
							<td colspan="3"><textarea class="rc2 content" name="mContent" id="mContent">${ email.mContent }</textarea></td>
						</tr>
					</table>
				</div>
			</form>
	...
	<script>
        ...
        $("#againtemp").click(function(){
           	oEditors.getById["mContent"].exec("UPDATE_CONTENTS_FIELD", []);
        	var formObj = $("form[name='form']");
        	formObj.attr("action", "updateTemp.do");
        	formObj.submit();
        });
    </script>
</body>
