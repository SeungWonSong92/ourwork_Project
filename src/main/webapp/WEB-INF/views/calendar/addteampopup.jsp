...
<body>
	<div class="group" id="popupGroup">
		...
		<div class="group-body">
			...
			<input id="ok-button" type="button" class="btn btn-secondary btn-sm" value="확인">		
			<input id="cancel" type="button" class="btn btn-secondary btn-sm" onclick="window.close()" value="취소">
			</form>
		</div>
	</div>
