...
<jsp:include page="../common/employeemenu.jsp"/>
        <div class="section1">
            <div class="menubar">
                <button id="selected1" onclick="location.href='eAddress.do'">주소록 조회</button>
             ...
             <div class="condition" align="right">
               <p class="title">주소록 조회</p>
                <form action="esearch.do" name="searchForm" method="get">
                      <input type="search" name="searchValue" value="${ search.searchValue }" placeholder="이름으로 검색하세요">
 ...
 -->
                        ...
                        <td>
                           <img id=pro src="${ contextPath }/resources/images/common/profile_none.png">
                                ...
                                <td>${e.dName}  ${ e.eName }<br>
                                        ${ e.phone }<br>
                                           ${ e.email }<br>
                                    <button class="minicon2"><img class="minicon" src="resources/images/common/b.mail.png" onclick="javascript:sendEmail('${ e.eId }@ourwork.com')"></button>
                                    <button class="minicon2"><img class="minicon" src="resources/images/common/send.png" onclick="javascript:sendReceiver('${ e.eId }')"></button>
                                </td>
                            </tr>
                            </c:forEach>  
                        </tbody>
         ...
         <div class="page_wrap">
                <div class="page_nation">
                   <!-- << 버튼 눌렀을 때 1페이지로 이동 -->
                   <c:url var="first" value="eAddress.do">
                   ...
                   <c:if test="${ pi.currentPage > 1 }">
                      <c:url var="before" value="eAddress.do">
                    ...
                    <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
                       ...
                       <c:if test="${ p eq pi.currentPage }">
								...
								<c:if test="${ p ne pi.currentPage }">
									<c:url var="pagination" value="eAddress.do">
                    ...
                    <c:if test="${ pi.currentPage < pi.maxPage }">
                       <c:url var="after" value="eAddress.do">
                          <c:param name="page" value="${ pi.currentPage + 1 }"/>
                       </c:url>
                    ...
                    <!-- 마지막 페이지로 -->
                    <c:url var="last" value="eAddress.do">
    ...
    <script>
        ...
        function sendEmail(eId){
			location.href="sendEmail.do?eId="+eId;
		}
        
        function sendReceiver(eId){
        	location.href="selectRcv.do?eId="+eId;
        }
    </script>
