											...
											<tbody>
												...
												<tr>
													...
													<td
														style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;">
														<span class="comp_item"
														style="font-family: &amp; amp; quot; malgun gothic&amp;amp; quot; , dotum , arial, tahoma; font-size: 9pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;">${aId }</span><br>
													</td>
												</tr>
											</tbody>
										</table>
							...
							<tbody>
								<tr>
									...
									<td
										...
										<span class="ipt_editor ipt_editor_date" size="40px" name="aTitle" >${a.aTitle }</span><br></td>
								</tr>
								<tr>
									<td
										style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; text-align: left; color: rgb(0, 0, 0); font-size: 14px; font-weight: normal; vertical-align: top;"
										colspan="2"><textarea rows="5" cols="80" class="ipt_editor" type="text" name="dContent" readonly style="resize:none">${d.dContent }</textarea><br></td>
								</tr>
							</tbody>
						</table> <br>
					</span>
