				...
				<table class="table table-hover">
					...
					<div class="page_wrap">
						<div class="page_nation">
							<!-- << 버튼 눌렀을 때 1페이지로 이동 -->
							<c:url var="first" value="aWaitingList.do">
							...
							<c:if test="${ pi.currentPage > 1 }">
								<c:url var="before" value="aWaitingList.do">
							...
							<c:forEach var="p" begin="${ pi.startPage }"
								...
								<c:if test="${ p ne pi.currentPage }">
									<c:url var="pagination" value="aWaitingList.do">
							...
							<c:if test="${ pi.currentPage < pi.maxPage }">
								<c:url var="after" value="aWaitingList.do">
									<c:param name="page" value="${ pi.currentPage + 1 }" />
								</c:url>
							...
							<!-- 마지막 페이지로 -->
							<c:url var="last" value="aWaitingList.do">
