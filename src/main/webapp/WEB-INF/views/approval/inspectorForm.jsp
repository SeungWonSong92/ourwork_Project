							...
							<tbody>
								<tr>
									...
									<td
										...
										<input class="ipt_editor ipt_editor_date" size="40px" type="text" name="aTitle" value="${a.aTitle }"><br></td>
								</tr>
								<tr>
									<td
										style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; text-align: left; color: rgb(0, 0, 0); font-size: 14px; font-weight: normal; vertical-align: top;"
										colspan="2"><textarea rows="5" cols="80" class="ipt_editor" type="text" name="dContent" style="resize:none">${d.dContent }</textarea><br></td>
								</tr>
							</tbody>
						</table> <br>
					</span>
