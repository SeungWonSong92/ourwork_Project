								...
								<tbody>
									<tr>
										...
										<td
											...
											<span class="ipt_editor ipt_editor_date" size="80px" style="font-size: 10pt;" name="eMatters">${ex.eMatters }</span><br>
										</td>
									</tr>
									<tr>
										<td
										...
										<td
											style="padding: 3px; height: 20px; border: 1px solid #000; vertical-align: middle">
											<span class="ipt_editor" name="eDate">${ex.eDate }</span><br>
										</td>
									</tr>
									<tr>
										<td
										...
										<td
											style="padding: 3px; height: 20px; border: 1px solid #000; vertical-align: middle">
											<span class="ipt_editor ipt_editor_date" size="80px" style="font-size: 10pt;" name="ePlace">${ex.ePlace }</span><br>
										</td>
									</tr>
									<tr>
										<td
										...
										<td
											style="padding: 3px; height: 20px; border: 1px solid #000; vertical-align: middle">
											<span class="ipt_editor ipt_editor_date" name="eStartDate">${ex.eStartDate }</span> ~ 
											<span class="ipt_editor ipt_editor_date" name="eEndDate">${ex.eEndDate }<br>
										</td>
									</tr>
									<tr>
										<td
										...
										<td
											style="padding: 3px; height: 20px; border: 1px solid #000; vertical-align: middle">
											<span class="ipt_editor ipt_editor_currency" size="80px" style="font-size: 10pt;" name="expenditure">${ex.expenditure }</span><br>
										</td>
									</tr>
									<tr>
										<td
										...
										<td
											style="padding: 3px; height: 20px; border: 1px solid #000; vertical-align: middle">
											<span class="ipt_editor" size="80px" style="font-size: 10pt;" name="account">${ex.account }<br>
										</td>
									</tr>
									<tr>
										<td colspan="2"
	...
	//결재선,참조
        ...
        function PrintDiv(div){
        	...
        	html2canvas(div).then(function(canvas){
        		...
        		downloadURI(myImge, "경조금 지급 신청서.png");
        	});
        }
