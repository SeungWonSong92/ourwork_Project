	...
	<input type="hidden" name="aName" value="경조금 지급 신청서">
		<div class="content1">
			<div id="buttongroup">
				...
				<button type="submit"class="btn1" id="btn2" onclick="javascript: form.action='expendInsert.do?aStatus=S'">
								...
								<tbody>
									<tr>
										...
										<td
											...
											<input class="ipt_editor ipt_editor_date" type="text" size="80px" style="font-size: 10pt;" name="eMatters" value="${ex.eMatters }"><br>
										</td>
									</tr>
									<tr>
										<td
										...
										<td
											style="padding: 3px; height: 20px; border: 1px solid #000; vertical-align: middle">
											<input class="ipt_editor" type="date" id="date1" name="eDate"><br>
										</td>
									</tr>
									<tr>
										<td
										...
										<td
											style="padding: 3px; height: 20px; border: 1px solid #000; vertical-align: middle">
											<input class="ipt_editor ipt_editor_date" type="text" size="80px" style="font-size: 10pt;" name="ePlace" value="${ex.ePlace }"> <br>
										</td>
									</tr>
									<tr>
										<td
										...
										<td
											style="padding: 3px; height: 20px; border: 1px solid #000; vertical-align: middle">
											<input class="ipt_editor ipt_editor_date" type="date" id="date2" name="eStartDate"> ~ 
											<input class="ipt_editor ipt_editor_date" type="date" id="date3" name="eEndDate"><br>
										</td>
									</tr>
									<tr>
										<td
										...
										<td
											style="padding: 3px; height: 20px; border: 1px solid #000; vertical-align: middle">
											<input class="ipt_editor ipt_editor_currency" type="text" size="80px" style="font-size: 10pt;" name="expenditure" value="${ex.expenditure }"><br>
										</td>
									</tr>
									<tr>
										<td
										...
										<td
											style="padding: 3px; height: 20px; border: 1px solid #000; vertical-align: middle">
											<input class="ipt_editor" type="text" size="80px" style="font-size: 10pt;" name="account" value="${ex.account }"><br>
										</td>
									</tr>
									<tr>
										<td colspan="2"
	...
	<script>
        ...
        $('#btn1').on('click', function() { 
        	if( $('#approvalinfo').is(':empty') ) {
        		...
        		formObj.attr("action", "expendInsert.do?aStatus=I");   
        		formObj.submit(); 
        	}
        });
        ...
        window.onload = function(){
        	if($("input[name=eDate]").val().trim().length == 0){
        	     document.getElementById('date1').valueAsDate = new Date();
        	}else{
        	      $("input[name=eDate]").val("${ex.eDate}");
        	 }
        	
			if($("input[name=eStartDate]").val().trim().length == 0){
        	     document.getElementById('date2').valueAsDate = new Date();
        	}else{
        	     $("input[name=eStartDate]").val("${ex.eStartDate}");
        	}
			
			if($("input[name=eEndDate]").val().trim().length == 0){
       	     document.getElementById('date3').valueAsDate = new Date();
	       	}else{
	       	     $("input[name=eEndDate]").val("${ex.eEndDate}");
	       	}     
   		}  
    </script>
</body>
