							...
							<tbody>
								<tr>
									...
									<td
										...
										<span class="ipt_editor" type="date" name="effectiveDate">${d.effectiveDate }</span><br>
									</td>
								</tr>
								<tr>
									<td
									...
									<td
										style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; height: 18px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;">
										<span class="ipt_editor" size="80" type="text" name="aTitle">${a.aTitle }</span><br>
									</td>
								</tr>
								<tr>
									<td
								...
								<tr>
									<td
										style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; height: 18px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;"
										colspan="2">
										<textarea rows="14" cols="130" name="dContent" readonly style="resize:none">${d.dContent }</textarea><br></td>
								</tr>
							</tbody>
						</table>
					</span>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="lupdate.do"  method="post">
                                           ...
                                           <table class="table">
                                               ...
                                               <tr>
                                                    <th>결재의견</th>
                                                    <td><textarea name="lContent" style="resize:none"></textarea></td>
                                               </tr>
                                           </table>
                                            <div class="modal-footer">
