...
<jsp:include page="../common/menubar.jsp"/>
							...
							<tbody>
								<tr>
									...
									<td
										...
										<input class="ipt_editor" type="date" name="effectiveDate" id="date1" min="${today}"><br>
									</td>
								</tr>
								<tr>
									<td
									...
									<td
										style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; height: 18px; text-align: left; color: rgb(0, 0, 0); font-size: 12px; font-weight: normal; vertical-align: middle;">
										<input class="ipt_editor" size="80" type="text" name="aTitle" value="${a.aTitle }"><br>
									</td>
								</tr>
								<tr>
									<td
	...
	<script>
        ...
        window.onload = function(){
        	if($("input[name=effectiveDate]").val().trim().length == 0){
        		document.getElementById('date1').valueAsDate = new Date();
        	}else{
        		$("input[name=effectiveDate]").val("${d.effectiveDate}");
        	}
   		}
    </script>
</body>
