...
<body>
    ...
    <div class="section"><br>
       <jsp:include page="../common/noticemenu.jsp" />
        ...
        <div class="section2">
        	<form action="tninsert.do" name="noForm" method="post" enctype="multipart/form-data" class="formt">
            <table id="boardTable">
                <tr>
                    <td class="division">제목</td>
                    <td><input type="text" name="nTitle" id="nTitle" class="in"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="file" id="uploadFile" name="uploadFile" class="in"></td>
                </tr>
                <tr>
