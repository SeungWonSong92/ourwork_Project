       ...
       <jsp:include page="../common/noticemenu.jsp" />
        ...
        <div class="section2">
            <div id="test" align="right">
                <p class="title">${ loginUser.dName } 공지사항</p>
                ...
                <!-- 페이징 처리! -->
                    <div class="page_wrap">
                        <div class="page_nation">
                            ...
                            <c:if test="${ pi.currentPage > 1 }">
                               <c:url var="before" value="tnoticeMain.do">
                            ...
                            <c:forEach var="p" begin="${ pi.startPage }"  end="${ pi.endPage }">
                               ...
                               <c:if test="${ p ne pi.currentPage }">
                                  <c:url var="pagination" value="tnoticeMain.do">
                            ...
                            <c:if test="${ pi.currentPage < pi.maxPage }">
                               <c:url var="after" value="tnoticeMain.do">
                                  <c:param name="page" value="${ pi.currentPage + 1 }"/>
                               </c:url>
   ...
   function nsdelete(){
      var check ="";
       ...
       if(check == ""){
          ...
          location.href = "tnoticesDelete.do?check="+ check;
      }
