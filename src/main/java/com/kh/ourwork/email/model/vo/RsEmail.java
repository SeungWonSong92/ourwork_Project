...
public class RsEmail {
	...
	public RsEmail(int mId, String eeId, String mTitle, String mContent, String mReceipt, Date sendDate,
			String mStatus, String sendStatus, int mLevel, String sStatus, String tStatus, String reId, int erLevel, Date receiveDate, String eName,
			String dName) {
		super();
		this.mId = mId;
		this.eeId = eeId;
	...
	public RsEmail(int mId, String eeId, String mTitle, String mContent, String mReceipt, Date sendDate, String mStatus,
			String sendStatus, int mLevel, String sStatus, String tStatus, String reId, int erLevel, Date receiveDate) {
		super();
		this.mId = mId;
		this.eeId = eeId;
		this.mTitle = mTitle;
	...
	public String toString() {
		return "RsEmail [mId=" + mId + ", eeId=" + eeId + ", mTitle=" + mTitle + ", mContent=" + mContent
				...
				+ sendStatus + ", mLevel=" + mLevel + ", sStatus=" + sStatus + ", tStatus=" + tStatus + ", reId=" + reId
				+ ", erLevel=" + erLevel + ", receiveDate=" + receiveDate + ", eName=" + eName + ", dName=" + dName
				+ "]";
	}
